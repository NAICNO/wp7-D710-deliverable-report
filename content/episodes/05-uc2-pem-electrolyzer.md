...
- See why 12 parameters beat ~50,000-parameter neural networks on OOD data
...
|-------|-----------|---------|-------------|
| **Student (PhysicsHybrid12Param)** | **12** | ~33 mV | **~18 mV** |
| Teacher (HybridPhysicsMLP) | ~9,354 | ~14 mV | ~20 mV |
| PureMLP | ~2,000 | ~8 mV | ~108 mV |
| BigMLP | ~50,000 | ~6 mV | ~99 mV |
| Transformer | ~50,000 | ~5 mV | ~118 mV |

The pure ML models win on in-distribution validation because they have orders of magnitude more parameters to memorize training patterns. But they **collapse on out-of-distribution data**. The 12-parameter student outperforms all neural networks on OOD by 5–6x.
