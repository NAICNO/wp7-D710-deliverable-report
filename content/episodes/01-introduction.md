...
All repositories are hosted on GitLab Sigma2 under the WP7 namespace:
...
| Sigma2 HPC (Saga/Betzy) | UC1 | SLURM batch processing for large-scale experiments |
| Jupyter Notebooks | All | Interactive demonstrator interfaces |
| Sphinx Tutorials (GitLab Pages) | All | Multi-chapter tutorial documentation |
...
|-------------|-------------|-----------|
| NORCE Research | Klaus Johannsen, Adrian Evensen, Hasan Asyari Arief, Xue-Cheng Tai, Gro Fonnes, Yngve Heggelund | UC1, UC2, UC5, UC6, UC7 |
| SINTEF Digital | Sølve Eidnes, Kjetil Olsen Lye | UC3 |
| UiB | Saruar Alam | UC4 |
| Sigma2 | Lorand Szentannai | UC1 |
...
- All demonstrators include Sphinx tutorials published on GitLab Pages
- Physics-informed approaches (UC2, UC3, UC7) generalize better with fewer parameters
- UC1 bridges interactive VM workflows with Sigma2 HPC batch processing
```
